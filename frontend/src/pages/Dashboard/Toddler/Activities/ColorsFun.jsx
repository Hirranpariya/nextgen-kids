        ...
        <div className="colors-fun-container">
            ...
            <header>
                <button 
                    ...
                    className="absolute top-4 left-4 py-2 px-4 rounded-full bg-white text-orange-500 font-black text-lg border-4 border-white shadow-[0_4px_0_rgba(0,0,0,0.2)] hover:-translate-y-1 hover:shadow-[0_6px_0_rgba(0,0,0,0.2)] active:translate-y-1 active:shadow-none transition-all z-50 flex items-center gap-2"
